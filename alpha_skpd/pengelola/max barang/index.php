...
<html>
	...
	<body>
		...
		<table align = "center" border = "0" cellpadding = "20">
			...
			<?php
				$tampil = mysql_query(" SELECT maks.kode_barang, brng.nama_barang, maks.jumlah, maks.satuan
			...
			<tr>
				...
				<td>
				<?php echo"<a href=?data=max%20barang/edit&&kode=$data[kode_barang]&&kode2=$kode>Edit</a>"; ?> | 
				<?php echo"<a href=\"?data=max%20barang/hapus&&kode=$data[kode_barang]&&kode2=$kode\" onClick=\"return confirm('Apakah Anda benar-benar akan menghapus data?')\">Hapus</a>"; ?>
				</td>
			</tr>
			<?php
				}
		...
		<h2 align=center>
			<a href="?data=max%20barang/input&&kode=<?php echo $kode?>"><button>Tambah</button></a>
		</h2>
	</body>
</html>
