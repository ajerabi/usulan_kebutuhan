<?php
	...
	$edit = mysql_query("select maks.kode_barang, brng.nama_barang, maks.jumlah, maks.satuan from barang brng , max_barang maks where maks.kode_barang=brng.kode_barang and maks.kode_barang='$_GET[kode]'");
...
<html>
    ...
    <body>
        ...
        <form method='POST' action='max%20barang/update.php'>
